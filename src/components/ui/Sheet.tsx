    ...
    <AnimatePresence>
      {open && (
        <div className="absolute inset-0 z-40">
          ...
          <motion.div
            role="dialog"
            className={`pb-safe absolute inset-x-[8px] bottom-[8px] rounded-[38px] px-5 pt-2 ${
          ...
          >
            <div className="-mx-5 -mt-2 flex h-[26px] touch-none cursor-grab items-center justify-center" onPointerDown={(e) => drag.start(e)}>
